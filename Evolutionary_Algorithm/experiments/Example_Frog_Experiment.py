...
experiment_name = "Example_Frog_Experiment" # This should be changed based on the experiment to reference the correct folder. Bot_name strategy will need to be adjusted if multiple bots exist in the bank
robot_names = ['FrogBot1', 'FrogBot2', 'FrogBot3', 'FrogBot4', 'FrogBot5'] # Array of all robot names in the provided URDF_Bank
