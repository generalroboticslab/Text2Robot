...
def run(context):
    ...
    try:
        ...
        ui.messageBox("started slicebody2")
        ...
        #returns sorted list of rel minima along xz cross section
        #possibleOffsets = getxzmin()
        ...
        #mainbody.material.materialProperties.density = 0.5
        ...
        #scaleNum2 = scaleFactorFromBody(7.05*1.5)
        ...
        #ui.messageBox("sliceByDX: slice = "+str(sliced)+" clean = "+str(cleanCut))
        ...
        #doc.saveAs("test", doc.dataFile.parentFolder, "", "")
...
def createMotorBox(comp: adsk.fusion.Component, point: adsk.fusion.SketchPoint, boxWidth, boxLength, isParent):
    try:
        ...
        childExtDist = adsk.core.ValueInput.createByReal(2)
        parentExtDist = adsk.core.ValueInput.createByReal(3.7)
        childExtDistNeg = adsk.core.ValueInput.createByReal(-2)
        parentExtDistNeg = adsk.core.ValueInput.createByReal(-3.7)
...
def createKneeBox(comp: adsk.fusion.Component, point: adsk.fusion.SketchPoint, boxWidth, boxLength, isParent):
    try:
        ...
        childExtDist = adsk.core.ValueInput.createByReal(2)
        parentExtDist = adsk.core.ValueInput.createByReal(2.5)
        childExtDistNeg = adsk.core.ValueInput.createByReal(-2)
        parentExtDistNeg = adsk.core.ValueInput.createByReal(-2.5)

        kneeChildExtDist = adsk.core.ValueInput.createByReal(-2.3)
        kneeParentExtDist = adsk.core.ValueInput.createByReal(2.8)
        ...
        plane2 = getPlane(point1.x - boxWidth/2, comp.yZConstructionPlane, comp)
        if not isParent:
            barPoint1 = adsk.core.Point3D.create(-centerPoint.z+legDepth-barDiam/2, point1.y + 1.4, 0)
            barPoint2 = adsk.core.Point3D.create(-centerPoint.z+legDepth-barDiam/2, point1.y - 1.4, 0)
        elif isParent:
            barPoint1 = adsk.core.Point3D.create(-centerPoint.z-baseDepth+barDiam/2, point1.y + 1.4, 0)
            barPoint2 = adsk.core.Point3D.create(-centerPoint.z-baseDepth+barDiam/2, point1.y - 1.4, 0)
