...
class DataPublisher:
    ...
    def __init__(
        self,
        target_url: str = 'udp://10.194.94.81:9871',
...
if __name__=="__main__":
    ...
    def test_data(id, t):
        """example test data"""
        return {"time":time.time()-time_since_start,"servo_id": id, "temperature": 25.5, "position": t}

    # Create a publisher instance
    publisher = DataPublisher(target_url="udp://10.194.94.81:9871", encoding_type="msgpack")
    # publisher = DataPublisher(target_url="udp://127.0.1.1:9871", encoding_type="msgpack")
    ...
    while True:
        # for id in range(0,8):
        t_list = [np.sin(t)*20+120 for i in range(8)]
        data = test_data(id,t_list)
        # print(data)
